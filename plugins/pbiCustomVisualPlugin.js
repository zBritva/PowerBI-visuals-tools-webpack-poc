...
PowerbiCustomVisualsWebpackPlugin.prototype.apply = function(compiler) {
  ...
  compiler.plugin("emit", (compilation, callback) => {
    ...
    let pluginOptions = {
      pluginName: `${this.options.visual.guid}_DEBUG`,
    ...
    // TODO include templates into plugin packages
    ...
    // console.log("visualPlugin", pluginTs);
    ...
    var jsonData = {
      visual: {
          ...
          guid: `${this.options.visual.guid}_DEBUG`,
    ...
    const status = `${new Date().getTime()}\n${this.options.visual.guid}_DEBUG`;
